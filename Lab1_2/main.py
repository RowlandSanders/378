...
def main_menu():
    ...
    print("1. Enter your own message")
    print("2. Exit")
    print("\n")


def presetMessages():
    print("Encrpyt message 1 - He who fights with monsters should... ")
    print("Encrpyt message 2 - There is a theory which states that...")
    print("Encrpyt message 3 - Whenever I find myself growing grim...")
    print("\n")
