...
def main():
    ...
    print("This program is running 2 decryptions of the same text, estimated time for results is about 4 mins per solution or 8 mins total (Ran in an online compiler)")
